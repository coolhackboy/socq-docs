...
| Instagram | Reels 搜索 | `POST /v1/instagram/reels-search` |
| Instagram | 音频 Reels | `POST /v1/instagram/audio-reels` |
| Instagram | 帖子详情 | `POST /v1/instagram/post-info` |
| Instagram | 热门 Reels | `POST /v1/instagram/trending-reels` |
| Instagram | 精选动态 | `POST /v1/instagram/story-highlights` |
| Instagram | 精选动态内容 | `POST /v1/instagram/highlight-items` |
...
| YouTube | 评论回复 | `POST /v1/youtube/comment-replies` |
| YouTube | 社区帖子 | `POST /v1/youtube/community-posts` |
| YouTube | 话题标签搜索 | `POST /v1/youtube/hashtag-search` |
| YouTube | 频道直播视频 | `POST /v1/youtube/channel-live-videos` |
| TikTok | 粉丝列表 | `POST /v1/tiktok/followers-list` |
| TikTok | 关注列表 | `POST /v1/tiktok/following-list` |
| TikTok | 评论回复 | `POST /v1/tiktok/comment-replies` |
| TikTok | 用户视频 | `POST /v1/tiktok/user-videos` |
| X | 粉丝列表 | `POST /v1/x/followers-list` |
| X | 关注列表 | `POST /v1/x/following-list` |
| X | 帖子回复 | `POST /v1/x/post-replies` |
| X | 引用帖子 | `POST /v1/x/post-quotes` |
| X | 转发用户 | `POST /v1/x/post-retweeters` |
| X | 趋势 | `POST /v1/x/trends` |
