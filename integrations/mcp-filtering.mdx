...
Typed tools add five optional control fields:
...
| `_result_view` | Return the compatible `full` view or fixed `standard` view; Skills should prefer `standard` |
| `_result_fields` | Project at most 50 comma-separated fields or dot paths from `standard` |
