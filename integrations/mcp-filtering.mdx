...
Typed tools add four optional control fields:
...
| `_result_fields` | Project at most 50 comma-separated fields or dot paths |
| `_idempotency_key` | Return the original task when retrying identical input within 24 hours; unfinished tasks remain protected until they finish |
