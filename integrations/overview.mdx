...
| CLI | Shell scripts and data export | `npm install -g @socq/cli` | Available |
| Agent Skill | Reusable research workflow | `npx skills add SocQAPI/socq-devtools` | Repository install |
