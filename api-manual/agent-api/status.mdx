...
| `results.schema_id` | string | Resource schema ID |
| `results.schema_version` | string | Resource schema version |
...
| `fields` | string | `null` | Up to 50 comma-separated fields or dot paths. |
