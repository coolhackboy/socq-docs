---
title: "Get Truth Social User Posts"
description: "Fetch normalized user posts data from Truth Social."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/truth-social/user-posts"
---

# Get Truth Social User Posts

Fetch normalized user posts data from Truth Social.
