---
title: "Get Snapchat Profiles"
description: "Fetch normalized profiles data from Snapchat."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/snapchat/profiles"
---

# Get Snapchat Profiles

Fetch normalized profiles data from Snapchat.
