---
title: "Get Bluesky Profiles"
description: "Fetch normalized profiles data from Bluesky."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/bluesky/profiles"
---

# Get Bluesky Profiles

Fetch normalized profiles data from Bluesky.
