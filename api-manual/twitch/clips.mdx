---
title: "Get Twitch Clips"
description: "Fetch normalized clips data from Twitch."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/twitch/clips"
---

# Get Twitch Clips

Fetch normalized clips data from Twitch.
