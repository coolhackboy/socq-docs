---
title: "Get Twitch User Videos"
description: "Fetch normalized user videos data from Twitch."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/twitch/user-videos"
---
