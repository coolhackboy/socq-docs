---
title: "Get Apple App Store Apps"
description: "Fetch normalized apps data from Apple App Store."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/apple-app-store/app-detail"
---

# Get Apple App Store Apps

Fetch normalized apps data from Apple App Store.
