---
title: "Get Amazon Products"
description: "Fetch normalized products data from Amazon."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/amazon/product-detail"
---

# Get Amazon Products

Fetch normalized products data from Amazon.
