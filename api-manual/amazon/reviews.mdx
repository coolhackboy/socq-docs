---
title: "Get Amazon Reviews"
description: "Fetch normalized reviews data from Amazon."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/amazon/reviews"
---

# Get Amazon Reviews

Fetch normalized reviews data from Amazon.
