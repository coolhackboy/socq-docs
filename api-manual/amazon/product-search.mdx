---
title: "Get Amazon Search"
description: "Fetch normalized search data from Amazon."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/amazon/product-search"
---

# Get Amazon Search

Fetch normalized search data from Amazon.
