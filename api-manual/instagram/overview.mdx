---
title: "Instagram"
description: "Collect public Instagram posts, reels, search results, and profile statistics."
icon: "instagram"
---
...
<Steps>
  ...
  <Step title="Read data">
    Use `/v1/tasks/{task_id}/results` for normalized rows or download raw JSONL from `files`.
  </Step>
</Steps>
