---
title: "Get Google Maps Places"
description: "Fetch normalized places data from Google Maps."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/google-maps/place-details"
---
...
Each non-empty submitted URL reserves `0.15` credits. The task settles at `0.15` credits per successfully returned standard result, and unused reserved credits are refunded.
