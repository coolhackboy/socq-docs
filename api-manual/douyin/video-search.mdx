---
title: "Get Douyin Search"
description: "Fetch normalized search data from Douyin."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/douyin/video-search"
---

# Get Douyin Search

Fetch normalized search data from Douyin.
