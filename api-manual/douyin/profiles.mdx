---
title: "Get Douyin Profiles"
description: "Fetch normalized profiles data from Douyin."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/douyin/profiles"
---

# Get Douyin Profiles

Fetch normalized profiles data from Douyin.
