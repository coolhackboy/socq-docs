---
title: "YouTube"
description: "Collect public YouTube channel, video, playlist, comment, Shorts, search, and transcript data."
icon: "youtube"
iconType: "brands"
---
...
| Playlist Videos | `POST` | `/v1/youtube/playlist-videos` |
| Comment Replies | `POST` | `/v1/youtube/comment-replies` |
| Community Posts | `POST` | `/v1/youtube/community-posts` |
| Hashtag Search | `POST` | `/v1/youtube/hashtag-search` |
| Channel Live Videos | `POST` | `/v1/youtube/channel-live-videos` |
