---
title: "Get Rednote Search"
description: "Fetch normalized search data from Rednote."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/rednote/search-notes"
---

# Get Rednote Search

Fetch normalized search data from Rednote.
