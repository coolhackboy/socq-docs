---
title: "Get Rednote Comment Replies"
description: "Fetch normalized comment replies data from Rednote."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/rednote/comment-replies"
---

# Get Rednote Comment Replies

Fetch normalized comment replies data from Rednote.
