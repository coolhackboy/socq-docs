---
title: "Get Rednote User Notes"
description: "Fetch normalized user notes data from Rednote."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/rednote/user-notes"
---

# Get Rednote User Notes

Fetch normalized user notes data from Rednote.
