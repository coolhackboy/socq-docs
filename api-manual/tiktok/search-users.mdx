...
description: "Search public TikTok creators and accounts by keyword."
openapi: "/api-manual/agent-api/agent-api.json POST /v1/tiktok/search-users"
---

# TikTok Search Users

Search public TikTok creators and accounts by keyword to collect normalized profile identity and metrics.
...
| Compact MCP | `socq_execute` with `endpoint: "tiktok/search-users"` |
| Typed MCP | `socq_tiktok_search_users` |
| Exact-tool URL | `https://api.socq.ai/mcp?tools=tiktok_search_users` |
